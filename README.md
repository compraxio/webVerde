...
- **Crear Negocio:** `/admin/negocios/admin/negocios/crearNegocio`
  - Formulario para registrar un nuevo emprendimiento. Requiere subir un logo y fotos de galería.
- **Editar Negocio:** `/admin/negocios/editarNegocio/[id_negocio]`
...
- **Gestión de Productos:** `/admin/productos/crear` y `/admin/productos/editar`
...
- **Gestión:** `/admin/contactos/crear` y `/admin/contactos/editar`
...
- **Gestión:** `/admin/eventos/crear`, `/admin/eventos/editar` y `/eventos/verEvento`
