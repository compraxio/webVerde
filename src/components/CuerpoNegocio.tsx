...
export function CuerpoNegocio() {
  ...
  if (isPending) {
    return <Skeleton className="rounded-2xl min-h-102.25 min-w-118.5"></Skeleton>;
  }

  return (
    <>
      {data?.data.map((n) => (
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6" key={n.id_negocio}>
          <div className="group bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-3xl overflow-hidden hover:shadow-xl transition-all duration-300">
            ...
            <div className="p-6">
              ...
              <div className="flex items-center justify-center border-t border-slate-100 dark:border-zinc-800 pt-4">
                <div className="flex items-center gap-2">
                  ...
                  <button className="bg-slate-100 dark:bg-zinc-800 hover:bg-slate-200 dark:hover:bg-zinc-700 px-4 py-1.5 rounded-lg text-xs font-semibold">
                    Ver Perfil
                  </button>
                </div>
              </div>
          ...
          <div className="border-2 border-dashed border-slate-200 dark:border-zinc-800 rounded-3xl p-6 flex flex-col items-center justify-center text-center gap-4 hover:bg-white dark:hover:bg-zinc-900 hover:border-primary/50 transition-all cursor-pointer min-h-100">
            <div className="w-16 h-16 bg-slate-50 dark:bg-zinc-800 rounded-full flex items-center justify-center text-slate-400">
