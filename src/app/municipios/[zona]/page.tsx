  ...
  return (
    <>
      <div className="flex-1 flex overflow-hidden">
        <aside className="flex flex-col items-center h-full border-r border-border p-6 shrink-0 bg-muted/50">
          <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-4">
            Zonas
          </h3>
          <div className="space-y-2">
            <Link
              className="w-full flex items-center justify-between px-4 py-2 text-muted-foreground hover:bg-accent rounded-xl transition-all"
        ...
        <section className="flex-1 flex flex-col min-w-0 bg-card">
          <div className="p-6 border-b border-border flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-card-foreground">Municipios</h2>
