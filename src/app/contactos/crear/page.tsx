  ...
  useEffect(() => {
    ...
    async function cargarNegocios() {
      ...
      if (negocios.length === 0) {
        toast.error('Debes crear un negocio antes de crear un contacto');
        router.push('/');
      }
    ...
    cargarNegocios();
  }, [setNegocios, router, isAuthenticated]);
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          >
            ...
            {negocios.map((n) => (
              <option key={n.id_negocio} value={n.id_negocio}>{n.negocio}</option>
            ))}
          </select>
